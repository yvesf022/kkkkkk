...
const NAV_CATS = [
  { label: "Anti-Aging",          category: "anti_aging",          emoji: "🌿" },
  { label: "Acne Care",           category: "acne",                emoji: "🎯" },
  { label: "Brightening",         category: "brightening",         emoji: "✨" },
  { label: "Whitening",           category: "whitening",           emoji: "🌟" },
  { label: "Hydration",           category: "hydration",           emoji: "💧" },
  { label: "Repair",              category: "repair",              emoji: "🔧" },
  { label: "Skin Barrier",        category: "barrier",             emoji: "🛡️" },
  { label: "Eczema",              category: "eczema",              emoji: "🌱" },
  { label: "Rosacea",             category: "rosacea",             emoji: "🌸" },
  { label: "Scar & Spots",        category: "scar",                emoji: "⚡" },
  { label: "Stretch Marks",       category: "stretch_mark",        emoji: "💪" },
  { label: "Sunscreen",           category: "sunscreen",           emoji: "☀️" },
  { label: "Oils",                category: "oils",                emoji: "🫒" },
  { label: "Soaps",               category: "soaps",               emoji: "🧼" },
  { label: "Body Care",           category: "body",                emoji: "🛁" },
  { label: "Masks",               category: "masks",               emoji: "🎭" },
  { label: "Exfoliation",         category: "exfoliation",         emoji: "🔬" },
  { label: "Clinical Acids",      category: "clinical_acids",      emoji: "⚗️" },
  { label: "African Ingredients", category: "african_ingredients", emoji: "🌍" },
  { label: "Korean Ingredients",  category: "korean_ingredients",  emoji: "🌸" },
];
...
const HERO_SLIDES = [
  {
    ...
    headline: "Glow From\nWithin",
    sub: "Brightening serums, Vitamin C & niacinamide — delivered to Lesotho",
    cta: "Shop Brightening",
    ctaLink: "/store?category=brightening",
    bg: "linear-gradient(135deg, #061a12 0%, #0a2a1f 50%, #1b5e4a 100%)",
    accent: "#c8a75a",
    filterCategory: "brightening",
  },
  {
    tag: "Repair & Restore",
    headline: "Restore &\nRenew",
    sub: "Repair creams, recovery serums & skin rebuild treatments",
    cta: "Shop Repair",
    ctaLink: "/store?category=repair",
    bg: "linear-gradient(135deg, #2d1b69, #5b21b6, #7c3aed)",
    accent: "#fce7f3",
    filterCategory: "repair",
  },
  {
    tag: "Sunscreen & Anti-Acne",
    headline: "Protect &\nClear",
    sub: "Broad-spectrum SPF + acne-control & pore-cleansing treatments",
    cta: "Shop Sunscreen",
  ...
  {
    tag: "Advanced Anti-Aging",
    headline: "Science\nMeets Nature",
    sub: "Collagen boosters, retinol serums & anti-wrinkle treatments",
    cta: "Shop Anti-Aging",
    ctaLink: "/store?category=anti_aging",
    bg: "linear-gradient(135deg, #0d2137, #1a3a6b, #2d5a9e)",
    accent: "#93c5fd",
    filterCategory: "anti_aging",
  },
  {
    tag: "Daily Hydration",
    headline: "Hydrate,\nNourish & Glow",
    sub: "Moisturisers, hyaluronic acid & daily hydration essentials",
    cta: "Shop Hydration",
    ctaLink: "/store?category=hydration",
  ...
  const banners = [
    {
      ...
      href: "/store?category=hydration", accent: "#c8a75a",
    },
    {
    ...
    },
    {
      ...
      href: "/store?category=anti_aging", accent: "#e9d5ff",
    },
  ];
...
const STORE_CATEGORIES = [
  {
    title: "Anti-Aging",
    desc: "Retinol, collagen boosters & wrinkle-fighting treatments",
    category: "anti_aging",
    color: "#4c1d95", light: "#ede9fe",
  },
  {
    title: "Hydration",
    desc: "Moisturisers, hyaluronic acid & daily hydration essentials",
    category: "hydration",
    color: "#0f3f2f", light: "#e6f2ee",
  },
  {
    title: "Acne Care",
    desc: "Spot treatments, pore cleansers & acne-fighting formulas",
    category: "acne",
    color: "#9b1c1c", light: "#fdecea",
  },
  {
    title: "Brightening",
    desc: "Vitamin C, niacinamide & glow-enhancing serums",
    category: "brightening",
    color: "#92400e", light: "#fef3cd",
  },
  {
    title: "Facial & Body Oils",
    desc: "Natural, pure & blended oils for skin and hair",
    category: "oils",
    color: "#065f46", light: "#d1fae5",
  },
  {
    title: "Sunscreen",
    desc: "SPF face & body protection, Korean no-white-cast & herbal SPF",
    category: "sunscreen",
    color: "#b45309", light: "#fef9c3",
  },
  {
    title: "Soaps & Cleansers",
    desc: "Bar soaps, kojic acid soaps & deep-cleansing formulas",
    category: "soaps",
    color: "#1e3a5f", light: "#e8eef8",
  },
  {
    title: "Masks & Treatments",
    desc: "Sheet masks, clay masks & overnight skin treatments",
    category: "masks",
    color: "#6b21a8", light: "#f5e8f8",
  },
  {
    title: "Exfoliation",
    desc: "Scrubs, peels, toner pads & enzyme exfoliants",
    category: "exfoliation",
    color: "#0e7490", light: "#e0f2fe",
  },
  {
    title: "Repair & Restore",
    desc: "Healing creams, recovery serums & barrier repair",
    category: "repair",
    color: "#166534", light: "#dcfce7",
  },
  {
    title: "African Ingredients",
    desc: "Shea butter, marula, baobab & African botanical extracts",
    category: "african_ingredients",
    color: "#7c2d12", light: "#ffedd5",
  },
  {
    title: "Korean Ingredients",
    desc: "K-beauty essentials — snail, centella, ginseng & more",
    category: "korean_ingredients",

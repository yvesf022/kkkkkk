...
export default function PaymentClient() {
  ...
  const initPayment = useCallback(async () => {
    ...
    // Step 1: Try to create a new payment session
    try {
      ...
      // FIX: We no longer call GET /api/payments/{orderId} with an orderId —
      //      that endpoint requires a real payment UUID, not an order ID.

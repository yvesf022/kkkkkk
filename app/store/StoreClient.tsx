...
const QUICK_FILTERS = [
  ...
  { label: "Moisturisers",    q: "category=moisturizer" },
  { label: "Sunscreen",       q: "category=sunscreen" },
  { label: "Face Wash",       q: "category=face_wash" },
  { label: "Serums",          q: "category=serum" },
  { label: "Face Masks",      q: "category=face_mask" },
  { label: "Exfoliators",     q: "category=exfoliator" },
  { label: "Anti-Acne",       q: "category=anti_acne" },
  { label: "Anti-Aging",      q: "category=anti_wrinkles" },
  { label: "Body Lotion",     q: "category=body_lotion" },
  { label: "Body Wash",       q: "category=body_wash" },

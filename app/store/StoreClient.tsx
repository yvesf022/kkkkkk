    ...
    <div className="store-root">
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .quick-btn:hover { border-color: var(--primary); color: var(--primary); background: #f0f7f4; }
        ...
        .filter-group { padding: 13px 0; border-bottom: 1px solid #f0efeb; }
        ...
        .price-inputs { display: flex; align-items: center; gap: 6px; margin-bottom: 7px; }
        ...
        .price-preset:hover, .price-preset.active { border-color: var(--primary); color: var(--primary); background: #f0f7f4; }
        ...
        .stock-toggle { display: flex; align-items: center; gap: 10px; background: none; border: none; cursor: pointer; padding: 0; }
        .toggle-track {
          width: 36px; height: 20px; border-radius: 10px;
          background: #d0cec8; position: relative; transition: background .2s; flex-shrink: 0;
        }
        ...
        .clear-btn {
          ...
          background: #fff8f8; color: #c0392b; font-weight: 700; font-size: 11px;
        ...
        /* ── MAIN CONTENT ── */
        .store-content { padding: 14px 20px; }
        .store-controls {
          display: flex; align-items: center; gap: 10px; margin-bottom: 12px;
        }
        .filter-active-badge {
          background: var(--primary); color: #fff; border-radius: 2px;
          padding: 0 5px; font-size: 9px; font-weight: 800; letter-spacing: 0.3px;
        }
        ...
        .sort-select {
          ...
          background: var(--white); font-size: 12px; color: var(--text); font-weight: 600;
        ...
        /* ── ACTIVE CHIPS ── */
        .active-filters { display: flex; gap: 5px; flex-wrap: wrap; margin-bottom: 10px; }
        .filter-chip {
        ...
        .chip-x {
          ...
          color: var(--primary); padding: 0; display: flex; align-items: center;
        ...
        .pcard:hover {
          ...
          z-index: 2; position: relative; transform: translateY(-1px);
        }
        ...
        .pcard-no-img {
          ...
          display: flex; align-items: center; justify-content: center; background: #ece9e4;
        }
        .pcard-badges {
          position: absolute; top: 8px; left: 8px;
          display: flex; flex-direction: column; gap: 3px; z-index: 3;
        }
        .pcard-badge { font-size: 9px; font-weight: 800; padding: 2px 6px; border-radius: 2px; letter-spacing: 0.3px; }
        ...
        .pcard-wish {
          ...
          z-index: 3; box-shadow: var(--shadow-sm); opacity: 0; transition: opacity .2s;
        }
        .pcard:hover .pcard-wish { opacity: 1; }
        .pcard-quick {
          position: absolute; bottom: 0; left: 0; right: 0;
          background: var(--primary); color: #fff; text-align: center;
          font-size: 10px; font-weight: 700; padding: 7px;
        ...
        .pcard-brand { font-size: 9px; color: var(--gold); font-weight: 800; text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 3px; }
        .pcard-title {
          font-size: 12px; color: var(--text); line-height: 1.45;
          display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;
          overflow: hidden; min-height: 34px; margin-bottom: 6px; font-weight: 400;
        }
        .pcard-price-row { display: flex; align-items: baseline; gap: 6px; margin-bottom: 5px; }
        ...
        /* ── EMPTY STATE ── */
        .empty-state { text-align: center; padding: 80px 20px; background: var(--white); }
        ...
        .load-more-btn {
          padding: 11px 42px; border-radius: var(--radius);
          border: 2px solid var(--text); background: var(--white); color: var(--text);
          font-weight: 800; font-size: 12px; cursor: pointer; transition: all .18s;
          letter-spacing: 0.3px; text-transform: uppercase; font-family: 'DM Sans', sans-serif;
        }
        .load-more-btn:hover:not(:disabled) { background: var(--primary); color: #fff; border-color: var(--primary); }
        .load-more-btn:disabled { opacity: 0.5; cursor: not-allowed; }
        .page-btns { display: flex; gap: 3px; flex-wrap: wrap; justify-content: center; }
        .page-btn {
        ...
        /* ── MOBILE DRAWER (kept for narrow-viewport zoom fallback) ── */
        .mob-filter-btn { display: none; }
        .mob-overlay { position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 500; display: none; }
        .mob-overlay.open { display: block; }
        .mob-drawer {
          position: fixed; left: 0; top: 0; bottom: 0; width: 285px;
          background: var(--white); z-index: 501; overflow-y: auto;
          padding: 18px 14px; animation: slideIn .25s ease;
        }
        .mob-drawer-head {
          display: flex; align-items: center; justify-content: space-between;
          margin-bottom: 18px; padding-bottom: 12px; border-bottom: 2px solid var(--primary);
        }
        .mob-drawer-title { font-size: 13px; font-weight: 800; color: var(--text); letter-spacing: 0.5px; text-transform: uppercase; }
        .mob-drawer-close { background: none; border: none; cursor: pointer; color: var(--text-muted); padding: 2px; display: flex; align-items: center; transition: color .15s; }
        .mob-drawer-close:hover { color: var(--text); }
        .mob-show-btn {
          width: 100%; margin-top: 14px; padding: 12px; border-radius: var(--radius);
          background: var(--primary); color: #fff; border: none; font-weight: 800; font-size: 13px;

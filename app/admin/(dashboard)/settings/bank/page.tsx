    ...
    <div style={{ display: "grid", gap: 28, maxWidth: 900 }}>
      ...
      <header>
        ...
        <p style={{ opacity: 0.6, marginTop: 4 }}>
          Configure bank accounts and mobile money details
      ...
      >
        <Input
          ...
          onChange={(v) =>
            setSettings({ ...settings, bank_name: v })
          }
        />
        ...
        <Input
          ...
          onChange={(v) =>
            setSettings({ ...settings, account_name: v })
          }
        />
        ...
        <Input
          ...
          onChange={(v) =>
            setSettings({ ...settings, account_number: v })
          }
        />
        ...
        <Input
          ...
          onChange={(v) =>
            setSettings({ ...settings, qr_code_url: v })
          }
        />
